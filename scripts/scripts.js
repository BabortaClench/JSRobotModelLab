...
const switchBtn = document.getElementById("model-button");

function clickHandler0() {
    const result1 = document.getElementById("model-text");

    if (modelName === "XYZ") {
        modelName = "CPRG";
        result1.innerHTML = "Model CPRG";
    } else {
        modelName = "XYZ";
        result1.innerHTML = "Model XYZ";
    }

    calculate();
}

switchBtn.addEventListener("click", clickHandler0);
